  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="relative z-10">
        ...
        <section id="produtos" className="relative z-10 mx-auto max-w-7xl px-4 py-16 md:px-8">
          <header className="mb-10 flex items-end justify-between">
            <div>
              <p className="text-xs uppercase tracking-[0.22em] text-primary">Seleção da casa</p>
              <h2 className="mt-2 font-display text-4xl md:text-5xl">Produtos em destaque</h2>
            </div>
          </header>
          <ProductGrid products={featured.length ? featured : filtered} />
        </section>
        ...
        {promos.length > 0 && (
          <section id="promocoes" className="relative z-10 mx-auto max-w-7xl px-4 py-16 md:px-8">
            <header className="mb-10 flex items-end justify-between">
              <div>
                <p className="text-xs uppercase tracking-[0.22em] text-primary">Ofertas especiais</p>
                <h2 className="mt-2 font-display text-4xl md:text-5xl">Promoções</h2>
              </div>
            </header>
